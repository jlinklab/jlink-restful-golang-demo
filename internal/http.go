...
const (
	//KRestFulApiHost = "https://rds.bcloud365.net"
	//KRestFulApiHost = "https://rds-test.bcloud365.net"
	KRestFulApiHost = "http://127.0.0.1:8089"
)
...
func HttpGet(apiUrl string) (body []byte, err error) {
	...
	repoUrl := fmt.Sprintf("%s%s", KRestFulApiHost, apiUrl)
